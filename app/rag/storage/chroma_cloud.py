...
class ChromaCloudVectorStore(BaseVectorStore):
    """Chroma Cloud hosted vector store implementation."""
  ...
  database=settings.chroma_cloud_database
            ...
            raise VectorStoreError(
                f"Failed to initialize Chroma Cloud: {str(e)}",
                details={
    ...
    async def add_chunks(self, chunks: List[DocumentChunk]) -> None:
        """
        Add document chunks to Chroma Cloud.
        ...
        try:
            ...
            raise VectorStoreError(
                f"Failed to add chunks to Chroma Cloud: {str(e)}",
    ...
    async def similarity_search(
        ...
        try:
            ...
            raise VectorStoreError(
                f"Failed to search Chroma Cloud: {str(e)}",
    ...
    async def delete_by_document_id(self, document_id: str) -> None:
        ...
        try:
            ...
            raise VectorStoreError(
                f"Failed to delete document from Chroma Cloud: {str(e)}",
    ...
    async def count(self) -> int:
        ...
        try:
            ...
            raise VectorStoreError(
                f"Failed to count chunks in Chroma Cloud: {str(e)}",
                details={"error": str(e)},
            )
